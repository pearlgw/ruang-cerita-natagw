...
CREATE TABLE `users` (
    ...
    `role` VARCHAR(191) NOT NULL DEFAULT 'writer',
...
-- AddForeignKey
ALTER TABLE `Like` ADD CONSTRAINT `Like_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
